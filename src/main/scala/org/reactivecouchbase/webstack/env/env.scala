...
trait EnvLike {
  ...
  def HttpClient(protocol: String, host: String, port: Int = 80): HttpClientFinal = org.reactivecouchbase.webstack.ws.HttpClient(protocol, host, port)(EnvLike.this)
  def WebSocketClient(protocol: String, host: String, port: Int = 80): WebSocketClientFinal = org.reactivecouchbase.webstack.ws.WebSocketClient(protocol, host, port)(EnvLike.this)
